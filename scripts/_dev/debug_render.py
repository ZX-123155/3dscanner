...
print("means mean:", params["means"].mean(0))
...
Image.fromarray(out).save(r"C:/Users/luyicheng/Desktop/3dscanner/output/debug_render.png")
gt = (img.cpu().numpy()*255).astype(np.uint8)
Image.fromarray(gt).save(r"C:/Users/luyicheng/Desktop/3dscanner/output/debug_gt.png")
